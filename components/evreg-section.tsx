...
export default function EvregSection({ reg }: Props) {
      ...
      <div key={reg.name} className={styles.container}>
        ...
        <div className={styles['reg-details']}>
          <div>
            ...
            <h2 className={styles['bio-header']}>Rules</h2>
            <p className={styles.bio}>{reg.rules}</p>
            <h2 className={styles['bio-header']}>Prizes</h2>
            <p className={styles.bio}>{reg.prize}</p>
